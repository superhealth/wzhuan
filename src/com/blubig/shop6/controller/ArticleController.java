...
import com.blubig.shop6.service.ArticleService;
...
public class ArticleController extends BaseController {
	...
	public ModelAndView listArticle(Page page){
		...
		try {
			...
			List<PageData> articlecates=articlecategoryService.sort(articleCategories, null);
			pd = this.getPageData();
			page.setPd(pd);
			List<PageData>	varList = articleService.list(page);	//列出Article列表
			this.getHC(); //调用权限
			mv.setViewName("bluebig/shop6/article/article_list");
	...
	public ModelAndView goAdd(){
		...
		try {
			List<PageData> articleCategories=articlecategoryService.listAll(new PageData());
			List<PageData> articlecates=articlecategoryService.sort(articleCategories, null);
			mv.setViewName("bluebig/shop6/article/article_edit");
