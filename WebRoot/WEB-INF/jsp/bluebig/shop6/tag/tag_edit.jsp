...
<body>
	<form action="tag/${msg }.do" name="Form" id="Form" method="post">
		...
		<table>
			...
			<tr>
				<td><input type="text" name="TAGTYPE" id="TAGTYPE" value="${pd.TAGTYPE}" maxlength="32" placeholder="这里输入类型" title="类型"/></td>
			</tr>
			<tr>
				<td><input type="text" name="ICON" id="ICON" value="${pd.ICON}" maxlength="32" placeholder="这里输入图标" title="图标"/></td>
			</tr>
			<tr>
